...
export function PaginaCadastro() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#78a3ff] via-[#286fbd] to-[#78a3ff] relative overflow-hidden">
            ...
            <div className="absolute top-[-80px] right-[-80px] w-80 h-80 rounded-full bg-white opacity-10" />
            <div className="absolute bottom-[-60px] left-[-40px] w-56 h-56 rounded-full bg-white opacity-10" />
