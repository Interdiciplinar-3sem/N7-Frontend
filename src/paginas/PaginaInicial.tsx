...
export function PaginaInicial() {
    return (
        <>
            <main className="relative flex w-screen flex-col overflow-hidden bg-[#F5F5F5] xxs:gap-14">
                ...
                <section className="relative px-4 py-6 xs:px-6 sm:py-10">
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                            <div className="max-w-3xl space-y-3">
                                ...
                                <p className="max-w-2xl text-sm leading-7 text-[#4D667D] sm:text-base lg:text-lg">
                                    Experiência completa pensadae em você: perfil com avatar, bio com mensagens prontas, criação de resumos e um feed dinâmico, enquanto a plataforma é cuidada por alguém por trás para manter tudo funcionando bem.
                                </p>
                            </div>
